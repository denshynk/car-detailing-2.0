			...
			<div className={`boxik ${styles.container}`}>
							...
							<div className="firstPageBox">
								<div className="content" ref={firstRef}>
									...
									<p>
										...
										оповіщення. Завдяки великому досвіду наших спеціалістів у
										нас в Auto Safe Culture ми підбираємо індивідуальні рішення
										під ваш автомобіль та в залежності від побажань
										автовласника. Для економії свого часу Ви можете попередньо
										ознайомитися з сучасними системами захисту і порівняти їх.
									</p>
						...
						>
							<div className="Box" ref={secondtRef}>
								...
								<p>
									...
									функціями. Радіус дії такого пульта обмежується тільки
									покриттям мобільного зв’язку, тобто наглядати за своїм
									автомобілем і керувати охороною можна.
								</p>
							</div>
						</div>
					</Section>
				...
				<div ref={section3}>
					...
					>
						...
						>
							<div className="Box">
								<h1 style={{}}>СИСТЕМИ ЗАХИСТУ З АВТОПУСКОМ</h1>
								<p>
						...
						>
							<div className="Box" ref={thirstRef}>
								...
								<p>
									...
									автосигналізацій, оскільки з досвідом наші спеціалісти можуть
									забезпечити надійний захист вашого авто.
								</p>
								<div className="megacontainer">
								...
								<div className="containerSavePage">
									<div className="card">
										...
										<p>
											...
											становлюється з допомогою спеціальних зривних болтів, які
									...
									<div className="card">
										...
										<p>
											...
											змоги дістатись до електронних засобів блокуваньпрацює в
											парі з встановленою системою захисту або штатною системою
											авто
										</p>
									</div>
									<div className="card">
										<img
											...
											alt="aproved"
										/>
										<h2>ЗАКЛАДНИЙ GPS ТРЕКЕР</h2>
										<p>
											з його допомогою можна відслідкувати місцезнаходження авто
											в в будь-якій точці світу завдяки технологіям GPS та LBS
											має мініатюрні розміри, працює повністю автономно, що дає
											змогу сховати його в будь-якому місці, де автомобіль
											абсолютно непомітно для викрадача
										</p>
									</div>
								</div>
							</div>
